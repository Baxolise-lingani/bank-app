...
class BankApplicationGUI:
    ...
    def create_main_screen(self):
        ...
        if not self.logged_in:
            ...
            self.button_login = tk.Button(self.root, text="Login", command=self.create_login_screen)
            self.button_exit = tk.Button(self.root, text="Exit", command=self.destroy)
    ...
    def create_account(self):
        ...
        self.clear_screen()
        self.label_fullname = tk.Label(self.root, text="Full Name:")
        ...
        self.label_dob = tk.Label(self.root, text="Date of Birth:")
        self.entry_dob = DateEntry(self.root, date_pattern="dd/mm/yyyy", validate="focusout", validatecommand=self.validate_date)

        self.label_employment = tk.Label(self.root, text="Employment Status:")
        ...
        self.label_cellphone = tk.Label(self.root, text="Cellphone Number:")
        self.entry_cellphone = tk.Entry(self.root)
        self.label_password = tk.Label(self.root, text="Password:")
        self.entry_password = tk.Entry(self.root, show="*")
        self.label_cpassword = tk.Label(self.root, text="Confirm Password:")
        ...
        self.button_back = tk.Button(self.root, text="Back", command=self.create_main_screen)
    ...
    def create_change_password_screen(self):
        ...
        self.label_confirm_new_password = tk.Label(self.root, text="Confirm New Password:")
        self.entry_confirm_new_password = tk.Entry(self.root, show="*")
        self.button_change_password = tk.Button(self.root, text="Change Password", command=self.process_change_password)
        self.button_back = tk.Button(self.root, text="Back", command=self.create_main_menu)
    ...
    def create_login_screen(self):
        ...
        self.button_forgot_password = tk.Button(self.root, text="Forgot Password", command=self.forgot_password)
        self.button_back = tk.Button(self.root, text="Back", command=self.create_main_screen)
    ...
    def create_main_menu(self):
        ...
        if full_name:
            self.label_welcome = tk.Label(self.root, text=f"Welcome, {full_name}!")  # Display full name
            ...
            self.button_view_balance = tk.Button(self.root, text="View Balance", command=self.view_balance)
            self.button_view_statement = tk.Button(self.root, text="View Statement", command=self.view_statement)

            self.button_change_password = tk.Button(self.root, text="Change Password", command=self.create_change_password_screen)
            self.button_change_password.pack()
    ...
    def deposit(self):
        self.clear_screen()
        self.label_amount = tk.Label(self.root, text="Enter amount to deposit:")
    ...
    def withdraw(self):
        self.clear_screen()
        self.label_amount = tk.Label(self.root, text="Enter amount to withdraw:")
        self.entry_amount = tk.Entry(self.root)
        self.button_withdraw = tk.Button(self.root, text="Withdraw", command=self.process_withdrawal)
        self.button_back = tk.Button(self.root, text="Back", command=self.create_main_menu)
